...
exports.submitContact = async function(req, res, next) {
    ...
    try {
        ...
        <p>We appreciate your interest in ${doesPetExist.name} and one of our staff members will reach ou to your shortly! Below is a copy of the message you sent us for your personal records:</p>
